...
public class EpollSpliceTest {
    ...
    @Test
    public void splice() throws Throwable {
            ...
            public void channelActive(final ChannelHandlerContext ctx) throws Exception {
                ...
                bs.group(ctx.channel().eventLoop()).handler(new ChannelInboundHandlerAdapter() {
                    ...
                    public void channelActive(ChannelHandlerContext context) throws Exception {
                        ...
                        EpollSocketChannel ch2 = (EpollSocketChannel) context.channel();
                        ...
                        ch2.spliceTo(ch, Integer.MAX_VALUE).addListener(new ChannelFutureListener() {
                            @Override
                            public void operationComplete(ChannelFuture future) throws Exception {
                                if (!future.isSuccess()) {
                                    future.cause().printStackTrace();
        ...
        Channel pc = bs.bind(new InetSocketAddress(0)).syncUninterruptibly().channel();
